...
def gen_video_1(nouns_file=None, activities_file=None):
    return from_file("video1.txt")

def gen_video_2(nouns_file=None, activities_file=None):
    return from_file("video2.txt")

def gen_video_3(nouns_file=None, activities_file=None):
    return from_file("video3.txt")

def gen_video_4(nouns_file=None, activities_file=None):
    return from_file("video4.txt")

def gen_video_5(nouns_file=None, activities_file=None):
    return from_file("video5.txt")
